 ...
 */
public class UseAgainPopup extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.use_again_layout);
    ...
    public void prePage() {
        Intent intent = new Intent(this, FavouriteTypePopup.class);
    ...
    public void nextPage() {
        Intent intent = new Intent(this, ThankyouPopup.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        overridePendingTransition (0, 0);
    ...
    public void onAnswer(View sender) {
        nextPage();
    }
}
