package com.example.td_advert.view;
...
public class CircularImageView extends ImageView {
	...
	public CircularImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		// {
		// setBorderWidth(attributes.getColor(R.styleable.CircularImageView_border_width,
		// 2));
		// setBorderColor(attributes.getInt(R.styleable.CircularImageView_border_color,
		// Color.WHITE));
		// }
		//
	...
	// canvas.getWidth(), canvas.getHeight(), false), Shader.TileMode.CLAMP,
